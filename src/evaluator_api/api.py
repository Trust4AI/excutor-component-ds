...
def evaluate_queri_api_request(expected_result: str, generated_result: str, eval_type: str, prompt:str = None):
    url = f'{EVALUATOR_API_URL}/evaluate?evaluation_type={eval_type}'

    data = schemas.Output(expected_result=expected_result, generated_result=generated_result, prompt=prompt)
